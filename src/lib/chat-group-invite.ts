...
export const CHAT_GROUP_INVITE_SUMMARY =
  "CHAT group: 2–3 same-gender friends meet weekly for accountability—Check progress, Hear the Word, Act on it, Tell others. Join me on BADWR to read and grow together.";
...
export function buildChatInviteShareText(params: {
  ...
  const core = `${who} invited you to a CHAT accountability group "${params.groupName}" on BADWR.\n\n${CHAT_GROUP_INVITE_SUMMARY}\n\nAccept (sign up with this invite link):\n${params.acceptUrl}`;
