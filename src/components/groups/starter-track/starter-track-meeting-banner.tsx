...
export function StarterTrackMeetingBanner({
  ...
  return (
    <div className="rounded-xl border border-secondary/50 bg-secondary/20 px-4 py-3 mb-6">
      <div className="flex items-start gap-3">
        <BookOpen className="size-5 text-secondary shrink-0 mt-0.5" />
        <div className="min-w-0 space-y-1 text-sm">
          ...
          <Link
            ...
            className="inline-block text-primary font-medium underline underline-offset-2"
          >
